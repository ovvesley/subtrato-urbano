<?php
/**
 * Adds Almighty_Recent_Post widget.
 */
class Almighty_Recent_Post extends WP_Widget {
    /**
    ...
    function __construct() {
        parent::__construct(
            'almighty_recent_posts_widget',
            esc_html__( 'Almighty Recent Posts', 'almighty' ),
            array( 'description' => esc_html__( 'Displays recent posts', 'almighty' ), )
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        <div class="tabbed-container">
            <div class="tab-content">
                <div id="almighty-recent" role="tabpanel" class="tab-pane">
                    <?php
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'post_category' ); ?>"><?php _e( 'Category:', 'almighty' ); ?></label>
            <?php
            $cat_args = array(
                'orderby'         => 'name',
                'hide_empty'      => 0,
                ...
                'show_option_all' => __( 'All Categories','almighty' ),
            );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'no_of_recent_posts' ) ); ?>">
                <?php esc_attr_e( 'No of Posts:', 'almighty' ); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'recent_content_length' ) ); ?>">
                <?php esc_attr_e( 'Content Length (Words):', 'almighty' ); ?>
            </label>
